...
bool draw_game(int, int, int, int, float, int, int, bool, background_effect, shape, shape, std::vector<shape>, bool, bool, bool, int);
bool draw_options(int, int, int, bool, int, bool, bool, bool, bool, int);
